- [Firebase Auth の準備](#orgef3aa56)
- [仮フロントエンドの作成](#org3fadaa2)
- [サインアップ・サインイン・サインアウトフローの確認](#org358c623)
  - [サインアップ](#orga4836ce)
  - [サインイン](#orgea1d7ea)
  - [サインアウト](#org6177063)
- [ドメイン・ハンドラの作成](#org7225955)
  - [domain](#orgc7834f5)
  - [ルータ & ハンドラ](#org7c0dc9c)
- [infrastructure の実装](#orgce83cde)
  - [Firebase Auth の token 読み込み](#org4b628ce)
  - [DB の接続](#org2f80e8c)
  - [マイグレーション](#org140e9c4)
    - [実装方針](#orgb3101f9)
    - [マイグレーションファイルを書く](#org4672318)
    - [integrant のコードを書く](#orgad04543)
    - [CLI スクリプトを書く](#org6352adf)
    - [サーバ用コードに埋め込む](#org009102e)
- [interface の実装](#orgf0c952e)
  - [Firebase Auth の token デコード機構](#org2a5a80d)
  - [SQL の実行機構](#org11f47b5)
- [interface の組み込み](#orgacfd3f7)
  - [サインアップ](#org218a938)
  - [サインイン](#org4b7d402)
  - [実装](#org5bb3374)
    - [サインアップ](#orgb56094f)
...
- [付録・捕捉](#orgaa94fa5)
  - [実装してみます](#org75b6864)
  - [ランダムな数列と衝突確率](#orgac8008f)
  - [テスト用データベースのセットアップ](#org5671566)
...
またユーザ ID は衝突確率などを考慮して [9.2](#orgac8008f) 、 15 桁の数字列としました。
...
[1](#orgef3aa56) で用意した、 `resources/secrets/firebase_secrets.json` を読み込んで encrypted-id-token をデコードするための準備を行います。 今回はライブラリのドキュメントを信用して説明を省略していますが、時間があれば **API ドキュメントを読んだほうが良いです** (~~サンプルが古すぎるなど~~) 。
...
仕様が見えてきたところで実装してみます ([9.1](#org75b6864))。
